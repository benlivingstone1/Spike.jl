...
# Code is adapted from: https://compneuro.neuromatch.io/tutorials/W2D3_BiologicalNeuronModels/student/W2D3_Tutorial1.html
...
module NeuronModule
    ...
    function run_LIF!(neuron::LIFNeuron, T::Float64, dt::Float64, I::Float64)
        ...
        Lt = length(range_t)  # Length of the experiment in terms of dt
    ...
    function run_LIF!(neuron::LIFNeuron, T::Float64, dt::Float64, I::Vector{Float64})
        # Set parameters
        range_t = [i for i = 0:dt:T]  # Vector for all time points
        Lt = length(range_t)  # Length of the experiment in terms of dt
